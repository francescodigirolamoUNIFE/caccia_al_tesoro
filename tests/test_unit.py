...
def test_suggerimenti_nord():
    """
    Testa che il suggerimento corretto venga dato per la direzione nord.
    """
    gioco = CacciaAlTesoro(dimensione_griglia=5)
    gioco.posizione_tesoro = (1, 1)
    suggerimenti = gioco._suggerisci((2, 1))
    assert "Il tesoro è più a NORD." in suggerimenti


def test_suggerimenti_sud():
    """
    Testa che il suggerimento corretto venga dato per la direzione sud.
    """
    gioco = CacciaAlTesoro(dimensione_griglia=5)
    gioco.posizione_tesoro = (5, 5)
    suggerimenti = gioco._suggerisci((4, 5))
    assert "Il tesoro è più a SUD." in suggerimenti


def test_suggerimenti_est():
    """
    Testa che il suggerimento corretto venga dato per la direzione est.
    """
    gioco = CacciaAlTesoro(dimensione_griglia=5)
    gioco.posizione_tesoro = (5, 5)
    suggerimenti = gioco._suggerisci((5, 4))
    assert "Il tesoro è più a EST." in suggerimenti


def test_suggerimenti_ovest():
    """
    Testa che il suggerimento corretto venga dato per la direzione ovest.
    """
    gioco = CacciaAlTesoro(dimensione_griglia=5)
    gioco.posizione_tesoro = (5, 1)
    suggerimenti = gioco._suggerisci((5, 2))
    assert "Il tesoro è più a OVEST." in suggerimenti
